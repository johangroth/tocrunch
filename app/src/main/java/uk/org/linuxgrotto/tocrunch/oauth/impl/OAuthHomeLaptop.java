 ...
 */
public class OAuthHomeLaptop extends Globals implements CrunchOAuthUrls {
    ...
    private static final String OAUTH_BASE_URL = "http://192.168.0.50:8080";
    private static final String API_BASE_URL = "http://192.168.0.50:8080/rest/v2";
